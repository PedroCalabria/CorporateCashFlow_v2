...
/**
 * Minimal accessible modal used by the bank-statement-import dialogs (feature-local, like the other
 * features). Closes only via the "X" button (or a dialog's own Cancel/submit) — clicking the backdrop
